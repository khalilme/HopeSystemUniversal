 ...
 public   class SpeechTranslateClient
    {
        ...
        /// <returns></returns>
        public async Task ConnectAsync(string from, string to, string voice, OnSpeechTranslateResult onSpeechTranslateResult, OnTextToSpeechData onTextToSpeechData)
        {
